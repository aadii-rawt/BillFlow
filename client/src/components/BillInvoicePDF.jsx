...
function BillInvoicePDF() {
    return (
        ...
        <div id="invoice" className="bg-white min-w-[600px] p-5 shadow-lg  relative overflow-hidden ">
            <div className="z-50 relative flex justify-between items-center text-sm">
                <div className='px-4'>
                    <h1 className="uppercase text-4xl font-semibold text-white">Bill</h1>
            ...
            <div className="text-right">
                ...
                <h1 className="text-gray-400 text-sm"> Generated by  <span className="text-blue-700 font-medium">BillFlow</span></h1>
            </div>
            {/* {data?.dueAmount > 0 && */}
                <div className="bg-yellow-200/70 border text-sm  !border-amber-500/50 p-2  px-4  mt-4 text-right">
                    <h1>Due Amount: <span className=" font-medium">₹357</span> | Due Date: <span className="font-medium">20/23/2024</span></h1>
                </div>
            {/* } */}
            <div>
            ...
            <div className="flex justify-between mt-5">
                ...
                <div className="font-semibold text-sm min-w-52  mb-60">
